...
export function TextInputFallback({ onSubmit }: TextInputFallbackProps) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div
        role="alert"
        className="bg-warning-surface border border-warning-border rounded-lg p-4"
      >
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-3">
        <input
          ...
          className="min-h-[48px] px-4 text-base border border-muted rounded-lg focus-visible:outline focus-visible:outline-4 focus-visible:outline-offset-2 focus-visible:outline-accent"
        />
        <button
          type="submit"
